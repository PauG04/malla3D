 ...
 *  
 * ESCENES: 
 *   El projecte nomès té una única escena ja que totes les variacions del experiment són aplicant canvis de solver o aplicar foces què és realitzaran sense canviar d'escena.
 *  
 * Peces de roba:
 *   
 *
